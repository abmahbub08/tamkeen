...
import SubcriptionCheckoutPage from "./pages/Subscription/SubscriptionCheckout";
import SubscriptionInfoPage from "./pages/Subscription/SubscriptionInfo";
import ReferralTreePage from "./pages/Subscription/ReferralTreePage";
      ...
      <div className="flex flex-col gap-10">
        ...
        <div>
          <Routes>
            ...
            <Route path="//subscription/checkout/:membership_id" element={<SubcriptionCheckoutPage />} /> {/* New checkout page */}
